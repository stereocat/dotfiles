(defun my-color-theme ()
  "Color theme by stereocat, created 2010-07-17."
  (interactive)
  (color-theme-install
   '(my-color-theme
     ...
     ((apropos-keybinding-face . underline)
      ...
      (list-matching-lines-face . color-occur-face)
      (moccur-maximum-displayed-with-color . 500)
      (rmail-highlight-face . rmail-highlight)
      (view-highlight-face . highlight)
      (widget-mouse-face . highlight))
     (default ((t (:stipple nil :background "darkslategrey" :foreground "wheat" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :family "*"))))
     ...
     (brace-face ((t (:foreground "medium orchid"))))
     ...
     (color-occur-face ((t (:bold t :background "SkyBlue" :foreground "Black" :weight bold))))
     ...
     (completions-common-part ((t (:family "*" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "wheat" :background "darkslategrey" :stipple nil :height 120))))
     ...
     (dired-header ((t (:bold t :weight bold :foreground "YellowGreen"))))
     (dired-ignored ((t (:foreground "grey70"))))
     (dired-mark ((t (:foreground "Aquamarine"))))
     (dired-marked ((t (:bold t :weight bold :foreground "red"))))
     (dired-perm-write ((t (:family "*" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "wheat" :background "darkslategrey" :stipple nil :height 120))))
     ...
     (flymake-errline ((t (:background "red1" :foreground "white"))))
     (flymake-warnline ((t (:background "yellow" :foreground "black"))))
...
;     (hl-line ((t (:foreground "DarkGreen" :background "PaleGreen"))))
     ...
     (iswitchb-current-match ((t (:bold t :weight bold :foreground "Aquamarine"))))
     (iswitchb-invalid-regexp ((t (:bold t :weight bold :foreground "red"))))
     (iswitchb-single-match ((t (:foreground "LightBlue"))))
     (iswitchb-virtual-matches ((t (:bold t :weight bold :foreground "PaleGreen"))))
     ...
     (mcomplete-history-method-alternative-part-face ((t (:foreground "Aquamarine"))))
     (mcomplete-history-method-fixed-part-face ((t (:bold t :foreground "Aquamarine" :weight bold))))
     (mcomplete-prefix-method-alternative-part-face ((t (:foreground "Aquamarine"))))
     (mcomplete-prefix-method-fixed-part-face ((t (:bold t :foreground "Aquamarine" :weight bold))))
     (mcomplete-substr-method-alternative-part-face ((t (:foreground "SpringGreen"))))
     (mcomplete-substr-method-fixed-part-face ((t (:bold t :foreground "SpringGreen" :weight bold))))
     ...
     (my-face-b-2 ((t (:foreground "RoyalBlue3" :underline t))))
...
;     (show-paren-match ((t (:bold t :background "Aquamarine" :foreground "steel blue" :weight bold))))
     (show-paren-match ((t (:bold t :underline t :weight bold))))
